...
function Light() {
  ...
  const isDevelopment = import.meta.env.VITE_CONTROLS_ENV === "development";
  ...
  const { x, y, z, intensity } = isDevelopment
    ? useControls("directionalLight settings", {
  ...
  }, [x, y, z, intensity, isDevelopment]);

  const { left, right, top, bottom, near, far } = isDevelopment
    ? useControls("orthographicCamera settings", {
  ...
  }, [left, right, top, bottom, near, far, isDevelopment]);

  const { xPl, yPl, zPl, powerPl } = isDevelopment
    ? useControls("pointLight settings", {
  ...
  }, [xPl, yPl, zPl, powerPl, isDevelopment]);
